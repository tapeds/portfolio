  ...
  return (
    ...
    >
      ...
      <div className="px-0 md:px-10">
        <h4 className="text-3xl font-light">Web Programmer Intern</h4>
        <p className="mt-1 text-xl font-bold">Barunastra ITS</p>
        ...
        <p className="py-3 uppercase text-[#D4D4D4]">Dec 2022 - Jan 2023</p>
      </div>
    </div>
  );
}
